 ...
 */
class AppApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\RecipeController' => 'getRecipeControllerService.php',
    ...
    {
        switch ($name) {
            case 'kernel.root_dir': $value = ($this->targetDirs[3].'/src/App'); break;
            ...
            case 'debug.container.dump': $value = ($this->targetDirs[0].'/AppApp_KernelDevDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.container_class' => 'AppApp_KernelDevDebugContainer',
            ...
            'router.cache_class_prefix' => 'AppApp_KernelDevDebugContainer',
