...
include_once $this->targetDirs[3].'/vendor/symfony/browser-kit/AbstractBrowser.php';
include_once $this->targetDirs[3].'/vendor/symfony/http-kernel/Client.php';
include_once $this->targetDirs[3].'/vendor/symfony/http-kernel/HttpKernelBrowser.php';
include_once $this->targetDirs[3].'/vendor/symfony/framework-bundle/Client.php';
include_once $this->targetDirs[3].'/vendor/symfony/framework-bundle/KernelBrowser.php';
